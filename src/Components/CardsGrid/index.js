        ...
        <div style={{display: "flex", flexDirection: "row", justifyContent: "center", marginBottom: "30px"}}>
            <div className="cardsGrid-container">
                <div className="cardsGrid-row">
                    <CardContent date="Maio/2020" content="Termo de adesão à convenção arbitral" status="1" fullWidth="false"/>
                ...
                <div className="cardsGrid-row">
                    ...
                    <CardContent date="Janeiro/2020" content="Termo de adesão à convenção arbitral" status="1" fullWidth="false"/>
                    <CardContent date="Dezembro/2019" content="Termo de adesão à convenção arbitral" status="1" fullWidth="false"/>
                </div>
                <div className="cardsGrid-row">
                    <CardContent date="Novembro/2019" content="Termo de adesão à convenção arbitral" status="1" fullWidth="false"/>
                    <CardContent date="Setembro/2019" content="Termo de adesão à convenção arbitral" status="1" fullWidth="false"/>
